...
HD_PWD='D:/CCU/DigitalSys/DDlab12/Lab12DemoV1.0_3/Lab12Demo.runs/clkwiz0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkwiz0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkwiz0.tcl
